...
class GUI:
    def __init__(self):
        ...
        self.image_tk= ImageTk.PhotoImage(self.image_original) #imports an image
        ...
        self.label.configure(font=("Times New Roman", 30,"bold"))
        ...
        self.button = ctk.CTkButton(self.frame,fg_color="#292929", text='START TEST', command=self.start_typing_test, width=50, height=40)
